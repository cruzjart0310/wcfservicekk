...
namespace WcfServiceKKreme
{
    ...
    public interface IService
    {
        ...
        ResponseBase<User> ShowUserById(int id);

        [OperationContract]
        [WebInvoke(Method = "GET", UriTemplate = "coupons", ResponseFormat = WebMessageFormat.Json)]
        ResponseBase<Coupon> AllCopuon();

        [OperationContract]
        [WebInvoke(Method = "GET", UriTemplate = "coupons/{id}", ResponseFormat = WebMessageFormat.Json)]
        ResponseBase<Coupon> ShowCopuonById(int id);
